...
export default function Footer() {
  return (
    <>
      <footer class="relative py-3 flex flex-col items-center bg-gradient-to-r from-indigo-500 from-10% via-sky-500 via-30% to-emerald-500 to-90% overflow-hidden">
            ...
            <div class="flex flex-wrap items-center justify-between md:flex-nowrap">
                <div class="w-full space-x-12 flex justify-center text-gray-300 sm:w-7/12 md:justify-start">
                    <ul class="list-disc list-inside space-y-8">
                        ...
                        <li><a href="#" class="hover:text-sky-400 transition">Cities</a></li>
                    ...
                    <div class="w-10/12 m-auto  mt-16 space-y-6 text-center sm:text-left sm:w-5/12 sm:mt-auto">
                        <span class="block text-gray-300">Find your perfect trip, designed by insiders who know and love their cities!</span>
                        <span class="block text-gray-300">Developed by Debi 🌈 &copy; 2023</span>
